...
const se = R(Array.prototype.forEach), Xt = R(Array.prototype.lastIndexOf), rt = R(Array.prototype.pop), V = R(Array.prototype.push), jt = R(Array.prototype.splice), ce = R(String.prototype.toLowerCase), De = R(String.prototype.toString), st = R(String.prototype.match), $ = R(String.prototype.replace), Vt = R(String.prototype.indexOf), $t = R(String.prototype.trim), L = R(Object.prototype.hasOwnProperty), A = R(RegExp.prototype.test), q = qt(TypeError);
function R(r) {
  return function(o) {
...
function gt() {
  ...
  }, $e = a({}, [...Ne, ...be, ...Zt]), qe = a({}, [...Ie, ...Jt]), zt = function(e) {
    let t = Q(e);
    (!t || !t.tagName) && (t = {
      namespaceURI: F,
      tagName: "template"
  ...
  const Qe = function(e) {
    ...
    if (!u[n] || B[n]) {
      ...
      if (Ae && !U[n]) {
        ...
        if (_ && c) {
          ...
          for (let O = d - 1; O >= 0; --O) {
            const N = Rt(_[O], !0);
            N.__removalCount = (e.__removalCount || 0) + 1, c.insertBefore(N, yt(e));
          }
        }
      }
      return D(e), !0;
    }
    return e instanceof xe && !zt(e) || (n === "noscript" || n === "noembed" || n === "noframes") && A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (D(e), !0) : (P && e.nodeType === Z.text && (t = e.textContent, se([me, pe, de], (c) => {
      t = $(t, c, " ");
    ...
    for (; c--; ) {
      ...
      if (et(ot, j, h)) {
        ...
        try {
          O ? e.setAttributeNS(O, d, h) : e.setAttribute(d, h), Le(e) ? D(e) : rt(o.removed);
        } catch {
        }
      }
    }
