export default {
    ...
    defaultdialogs: {
        ...
        confirmTrash: (name) => `Er du sikker på, at du vil flytte <strong>${name}</strong> til papirkurven?`,
        confirmBulkTrash: (total) => `Er du sikker på, at du vil flytte <strong>${total} ${total === 1 ? 'element' : 'elementer'}</strong> til papirkurven?`,
        confirmBulkDelete: (total) => `Er du sikker på, at du vil slette <strong>${total} ${total === 1 ? 'element' : 'elementer'}</strong>?`,
    },
    dictionary: {
    ...
    contentPicker: {
        ...
        unsupportedHeadline: (type) => `<strong>Ikke-understøttede ${type ?? 'indholds'} elementer</strong><br>Følgende indhold understøttes ikke længere i denne editor.`,
        unsupportedMessage: 'Hvis du stadig har brug for dette indhold, bedes du kontakte din administrator. Ellers kan du fjerne det.',
    ...
    speechBubbles: {
        ...
        editMultiVariantUnpublishedText: '%0% dokumenter afpubliceret for sprogene %1% og ikke længere synlige for besøgende',
    ...
    user: {
        ...
        languageNotFound: (culture, baseCulture) => `Den angivne kultur "${culture}" blev ikke fundet, basis-kulturen "${baseCulture}" vil blive brugt.`,
        languageNotFoundFallback: (culture, baseCulture) => `Hverken den angivne kultur "${culture}" eller basis-kulturen "${baseCulture}" blev fundet, standard fallback-kulturen "Engelsk (UK)" vil blive brugt.`,
    ...
    blockEditor: {
        ...
        blockVariantConfigurationNotSupported: 'En eller flere bloktyper i denne blokeditor bruger en elementtype, der er konfigureret til at variere efter kultur eller segment. Dette understøttes ikke på et indholdselement, som ikke varierer efter kultur eller segment.',
    ...
    routing: {
        ...
        routeForbiddenDescription: 'Du har ikke tilladelse til at få adgang til denne ressource. Kontakt venligst din administrator for hjælp.',
    },
    codeEditor: {
        label: 'Code editor',
    ...
    tiptap: {
        ...
        config_dimensions_description: 'Angiver en fast bredde og højde for editoren. Dette ekskluderer værktøjslinjens og statuslinjens højder.',
        ...
        charmap_arrows: 'Pile',
        statusbar_characters: (count) => `${count.toLocaleString()} tegn`,
        statusbar_words: (count) => `${count.toLocaleString()} ord`,
    },
    collection: {
    ...
    linkPicker: {
        modalSource: 'Kilde',
        modalManual: 'Manuel',
        modalAnchorValidationMessage: 'Indtast et anker eller en querystring, vælg et dokument eller medieelement, eller konfigurer URL’en manuelt.',
