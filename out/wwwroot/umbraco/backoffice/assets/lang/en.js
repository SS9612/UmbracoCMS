export default {
    ...
    contentPicker: {
        ...
        unsupportedHeadline: (type) => `<strong>Unsupported ${type ?? 'content'} items</strong><br>The following content is no longer supported in this Editor.`,
    ...
    nuCache: {
        ...
        databaseCacheDescription: 'This button lets you rebuild the database cache, e.g. the content of the cmsContentNu table. <strong>Rebuilding can be expensive.</strong> Use it when reloading is not enough, and you think that the database cache has not been properly generated &mdash; which would indicate some critical Umbraco issue.',
        rebuild: 'Rebuild',
        internals: 'Internals',
    ...
    routing: {
        ...
        routeForbiddenDescription: 'You do not have permission to access this resource. Please contact your administrator for assistance.',
    },
    codeEditor: {
        label: 'Code editor',
    ...
    tiptap: {
        ...
        config_dimensions_description: 'Sets the fixed width and height of the editor. This excludes the toolbar and statusbar heights.',
        ...
        statusbar_characters: (count) => `${count.toLocaleString()} ${count === 1 ? 'character' : 'characters'}`,
        statusbar_words: (count) => `${count.toLocaleString()} ${count === 1 ? 'word' : 'words'}`,
    },
    linkPicker: {
        modalSource: 'Source',
        modalManual: 'Manual',
