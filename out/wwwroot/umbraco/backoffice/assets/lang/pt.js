export default {
    ...
    assignDomain: {
        ...
        domainHelpWithVariants: 'Nomes de domínio válidos são: "example.com", "www.example.com", "example.com:8080", ou "https://www.example.com/". Além disso, também são suportados caminhos de um nível em domínios, por exemplo, "example.com/en" ou "/en".',
        inherit: 'Herdar',
        setLanguage: 'Cultura',
        setLanguageHelp: 'Defina a cultura para os nós abaixo do nó atual,<br /> ou herde a cultura dos nós pais. Também se aplicará<br /> ao nó atual, a menos que um domínio abaixo também se aplique.',
        setDomains: 'Domínios',
    },
    buttons: {
    ...
    content: {
        ...
        parentCultureNotPublished: "Esta cultura está publicada mas não está visível porque não está publicada no pai '%0%'",
        ...
        publishDescendantsHelp: 'Publicar <strong>%0%</strong> e todos os itens abaixo e, assim, tornar o seu conteúdo publicamente disponível.',
        publishDescendantsWithVariantsHelp: 'Publicar variantes e variantes do mesmo tipo abaixo e, assim, tornar o seu conteúdo publicamente disponível.',
        ...
        sortHelp: 'Para ordenar os nós, simplesmente arraste os nós ou clique num dos cabeçalhos das colunas. Pode selecionar múltiplos nós mantendo premida a tecla "shift" ou "control" enquanto seleciona',
        ...
        scheduledPublishDocumentation: '<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_blank" rel="noopener">O que significa isto?</a>',
        ...
        nestedContentGroupHelpText: 'Selecione o grupo cujas propriedades devem ser exibidas. Se deixado em branco, o primeiro grupo no Tipo de Elemento será usado.',
        ...
        nestedContentNoGroups: 'O tipo de elemento selecionado não contém quaisquer grupos suportados (os separadores não são suportados por este editor, altere-os para grupos ou use o editor de Block List).',
        ...
        isSensitiveValue: 'Este valor está oculto. Se precisar de acesso para visualizar este valor, entre em contacto com o administrador do seu site.',
        ...
        languagesToUnpublish: 'Selecione os idiomas a despublicar. Despublicar um idioma obrigatório despublicará todos os idiomas.',
    ...
    blueprints: {
        ...
        blueprintDescription: 'Um Modelo de Documento é conteúdo predefinido que um editor pode selecionar para usar como base para criar novo conteúdo',
    },
    entityDetail: {
    ...
    media: {
        ...
        disallowedMediaType: "Não é possível carregar este ficheiro, o tipo de multimédia com o alias '%0%' não é permitido aqui",
    ...
    create: {
        ...
        noDocumentTypes: 'Não existem Tipos de Documento permitidos disponíveis para criar conteúdo aqui. Deve ativá-los em <strong>Tipos de Documento</strong> na secção <strong>Definições</strong>, editando os <strong>Tipos de nó filho permitidos</strong> em <strong>Permissões</strong>.',
        noDocumentTypesAtRoot: 'Não existem Tipos de Documento disponíveis para criar conteúdo aqui. Deve criá-los em <strong>Tipos de Documento</strong> na secção <strong>Definições</strong>.',
        noDocumentTypesWithNoSettingsAccess: 'A página selecionada na árvore de conteúdo não permite a criação de nenhuma página abaixo dela.',
        ...
        noDocumentTypesAllowedAtRoot: 'Não existem Tipos de Documento permitidos disponíveis para criar conteúdo aqui. Deve ativá-los em <strong>Tipos de Documento</strong> na secção <strong>Definições</strong>, alterando a opção <strong>Permitir como raiz</strong> em <strong>Permissões</strong>.',
        noMediaTypes: 'Não existem Tipos de Multimédia permitidos disponíveis para criar multimédia aqui. Deve ativá-los em <strong>Tipos de Multimédia</strong> na secção <strong>Definições</strong>, editando os <strong>Tipos de nó filho permitidos</strong> em <strong>Permissões</strong>.',
        noMediaTypesWithNoSettingsAccess: 'A multimédia selecionada na árvore não permite a criação de nenhuma outra multimédia abaixo dela.',
        ...
        documentTypeWithTemplateDescription: 'A definição de dados para uma página de conteúdo que pode ser criada por editores na árvore de conteúdo e é diretamente acessível através de um URL.',
        documentType: 'Tipo de Documento',
        documentTypeDescription: 'A definição de dados para um componente de conteúdo que pode ser criado por editores na árvore de conteúdo e ser escolhido noutras páginas, mas não tem URL direto.',
        elementType: 'Tipo de Elemento',
        elementTypeDescription: "Define o esquema para um conjunto repetido de propriedades, por exemplo, num editor de propriedades 'Block List' ou 'Block Grid'.",
        composition: 'Composição',
        compositionDescription: "Define um conjunto reutilizável de propriedades que pode ser incluído na definição de múltiplos outros Tipos de Documento. Por exemplo, um conjunto de 'Definições Comuns de Página'.",
        folder: 'Pasta',
    ...
    prompt: {
        ...
        confirmListViewUnpublish: 'A despublicação tornará os itens selecionados e todos os seus descendentes publicamente indisponíveis.',
        confirmPublish: 'A publicação tornará este conteúdo e todos os seus descendentes publicados publicamente disponíveis.',
        confirmUnpublish: 'A despublicação tornará este conteúdo publicamente indisponível.',
        doctypeChangeWarning: 'Tem alterações não guardadas. Fazer alterações ao Tipo de Documento descartará as alterações.',
    },
    bulk: {
        done: 'Concluído',
    ...
    defaultdialogs: {
        ...
        confirmdelete: (name) => `Tem a certeza que quer eliminar${name ? ` <strong>${name}</strong>` : ''}?`,
        ...
        confirmTrash: (name) => `Tem a certeza que quer mover <strong>${name}</strong> para a Reciclagem?`,
        confirmBulkTrash: (total) => `Tem a certeza que quer mover <strong>${total} ${total === 1 ? 'item' : 'itens'}</strong> para a Reciclagem?`,
        confirmBulkDelete: (total) => `Tem a certeza que quer eliminar <strong>${total} ${total === 1 ? 'item' : 'itens'}</strong>?`,
        cut: 'Cortar',
        ...
        languageChangeWarning: 'Alterar a cultura de um idioma pode ser uma operação dispendiosa e resultará na reconstrução da cache de conteúdo e dos índices',
        ...
        recycleBinDeleting: 'Os itens na reciclagem estão agora a ser eliminados. Por favor, não feche esta janela enquanto esta operação está a decorrer',
        ...
        regexSearchError: "O serviço web de <a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a> está atualmente com alguns problemas, sobre os quais não temos controlo. Lamentamos muito este inconveniente.",
        regexSearchHelp: "Procure uma expressão regular para adicionar validação a um campo de formulário. Exemplo: 'email, 'código postal', 'URL'.",
        removeMacro: 'Remover Macro',
        requiredField: 'Campo Obrigatório',
        sitereindexed: 'O site foi reindexado',
        siterepublished: 'A cache do website foi atualizada. Todo o conteúdo publicado está agora atualizado. Enquanto todo o conteúdo não publicado continua não publicado',
        siterepublishHelp: 'A cache do website será atualizada. Todo o conteúdo publicado será atualizado, enquanto o conteúdo não publicado permanecerá não publicado.',
        ...
        variantdeletewarning: 'Isto eliminará o nó e todos os seus idiomas. Se quiser eliminar apenas um idioma, deve despublicar o nó nesse idioma.',
        ...
        deletingALayout: 'Modificar o layout resultará na perda de dados para qualquer conteúdo existente que seja baseado nesta configuração.',
        seeErrorAction: 'Ver erro',
        seeErrorDialogHeadline: 'Detalhes do erro',
    },
    dictionary: {
        importDictionaryItemHelp: 'Para importar um item do dicionário, encontre o ficheiro ".udt" no seu computador clicando no botão "Adicionar" (ser-lhe-á pedida confirmação no ecrã seguinte).',
    ...
    examineManagement: {
        ...
        configuredSearchersDescription: 'Mostra propriedades e ferramentas para qualquer Pesquisador configurado (por exemplo, um pesquisador de múltiplos índices)',
        ...
        manageIndexesDescription: 'Permite visualizar os detalhes de cada índice e fornece algumas ferramentas para gerir os índices',
        rebuildIndex: 'Reconstruir índice',
        rebuildIndexWarning: 'Isto fará com que o índice seja reconstruído.<br /> Dependendo da quantidade de conteúdo no seu site, isto pode demorar algum tempo.<br /> Não é recomendado reconstruir um índice durante períodos de tráfego elevado no website ou quando os editores estão a editar conteúdo.',
        ...
        processIsTakingLonger: 'O processo está a demorar mais do que o esperado, verifique o log do Umbraco para ver se ocorreram erros durante esta operação',
    ...
    editdatatype: {
        canChangePropertyEditorHelp: 'Alterar um editor de propriedades num tipo de dados com valores armazenados está desativado. Para permitir isto, pode alterar a definição Umbraco:CMS:DataTypes:CanBeChanged em appsettings.json.',
        ...
        hasReferencesDeleteConsequence: 'Eliminar <strong>%0%</strong> eliminará as propriedades e os seus dados dos seguintes itens',
        acceptDeleteConsequence: 'Compreendo que esta ação eliminará as propriedades e os dados baseados neste Tipo de Dados',
        noConfiguration: 'Não existe configuração para este editor de propriedades.',
    },
    errorHandling: {
        errorButDataWasSaved: 'Os seus dados foram guardados, mas antes de poder publicar esta página, existem alguns erros que precisa de corrigir primeiro:',
        errorChangingProviderPassword: 'O fornecedor de membros atual não suporta a alteração de palavra-passe (EnablePasswordRetrieval precisa de ser verdadeiro)',
        errorExistsWithoutTab: '%0% já existe',
        errorHeader: 'Ocorreram erros:',
        errorHeaderWithoutTab: 'Ocorreram erros:',
        errorInPasswordFormat: 'A palavra-passe deve ter um mínimo de %0% caracteres e conter pelo menos %1% carácter(es) não alfanumérico(s)',
    ...
    errors: {
        ...
        codemirroriewarning: 'NOTA! Embora o CodeMirror esteja ativado por configuração, está desativado no Internet Explorer porque não é suficientemente estável.',
        ...
        pictureResizeBiggerThanOrg: 'Está prestes a tornar a imagem maior do que o tamanho original. Tem a certeza que quer prosseguir?',
        ...
        externalLoginFailed: 'O servidor falhou ao autorizá-lo junto do fornecedor de login externo. Por favor, feche a janela e tente novamente.',
    ...
    installer: {
        ...
        databaseErrorWebConfig: 'Não foi possível guardar o ficheiro web.config. Por favor, modifique a "connection string" manualmente.',
        ...
        databaseInstallDone: 'O Umbraco %0% foi agora copiado para a sua base de dados. Pressione <strong>Seguinte</strong> para prosseguir.',
        databaseNotFound: '<p>Base de dados não encontrada! Por favor, verifique se a informação na "connection string" do ficheiro "web.config" está correta.</p><p>Para prosseguir, por favor edite o ficheiro "web.config" (usando o Visual Studio ou o seu editor de texto favorito), desloque-se até ao final, adicione a cadeia de ligação para a sua base de dados na chave chamada "UmbracoDbDSN" e guarde o ficheiro.</p><p>Clique no botão <strong>tentar novamente</strong> quando terminar.<br /><a href="https://our.umbraco.com/documentation/Reference/Config/webconfig/" target="_blank" rel="noopener">Mais informação sobre como editar o web.config aqui</a>.</p>',
        databaseText: 'Para completar este passo, deve saber alguma informação sobre o seu servidor de base de dados ("connection string").<br />   Por favor, contacte o seu ISP, se necessário.   Se estiver a instalar numa máquina ou servidor local, poderá precisar de informação do seu administrador de sistema.',
        databaseUpgrade: ' <p> Pressione o botão <strong>atualizar</strong> para atualizar a sua base de dados para Umbraco %0%</p> <p> Não se preocupe - nenhum conteúdo será eliminado e tudo continuará a funcionar depois! </p> ',
        databaseUpgradeDone: 'A sua base de dados foi atualizada para a versão final %0%.<br />Pressione <strong>Seguinte</strong> para prosseguir.',
        databaseUpToDate: 'A sua base de dados atual está atualizada!. Clique em <strong>seguinte</strong> para continuar o assistente de configuração',
        defaultUserChangePass: '<strong>A palavra-passe do utilizador Predefinido precisa de ser alterada!</strong>',
        defaultUserDisabled: '<strong>O utilizador Predefinido foi desativado ou não tem acesso ao Umbraco!</strong></p><p>Nenhuma ação adicional é necessária. Clique em <strong>Seguinte</strong> para prosseguir.',
        defaultUserPassChanged: '<strong>A palavra-passe do utilizador Predefinido foi alterada com sucesso desde a instalação!</strong></p><p>Nenhuma ação adicional é necessária. Clique em <strong>Seguinte</strong> para prosseguir.',
        defaultUserPasswordChanged: 'A palavra-passe foi alterada!',
        greatStart: 'Comece em grande, veja os nossos vídeos de introdução',
        licenseText: 'Ao clicar no botão seguinte (ou modificar o umbracoConfigurationStatus no web.config), aceita a licença para este software conforme especificado na caixa abaixo. Note que esta distribuição Umbraco consiste em duas licenças diferentes, a licença MIT de código aberto para o framework e a licença freeware Umbraco que cobre a UI.',
        ...
        permissionsAffectedFoldersText: 'Precisa de conceder permissões de modificação ASP.NET aos seguintes ficheiros/pastas',
        permissionsAlmostPerfect: '<strong>As suas definições de permissão estão quase perfeitas!</strong><br /><br />   Pode executar o Umbraco sem problemas, mas não poderá instalar pacotes, o que é recomendado para tirar o máximo partido do Umbraco.',
        permissionsHowtoResolve: 'Como Resolver',
        permissionsHowtoResolveLink: 'Clique aqui para ler a versão em texto',
        permissionsHowtoResolveText: 'Veja o nosso <strong>tutorial em vídeo</strong> sobre como configurar permissões de pasta para o Umbraco ou leia a versão em texto.',
        permissionsMaybeAnIssue: '<strong>As suas definições de permissão podem ser um problema!</strong><br/><br />Pode executar o Umbraco sem problemas, mas não poderá criar pastas ou instalar pacotes, o que é recomendado para tirar o máximo partido do Umbraco.',
        permissionsNotReady: '<strong>As suas definições de permissão não estão prontas para o Umbraco!</strong><br /><br />Para executar o Umbraco, terá de atualizar as suas definições de permissão.',
        permissionsPerfect: '<strong>As suas definições de permissão estão perfeitas!</strong><br /><br />Está pronto para executar o Umbraco e instalar pacotes!',
        permissionsResolveFolderIssues: 'Resolver problemas de pasta',
        permissionsResolveFolderIssuesLink: 'Siga este link para mais informação sobre problemas com ASP.NET e criação de pastas',
        permissionsSettingUpPermissions: 'Configurar permissões de pasta',
        permissionsText: ' O Umbraco precisa de acesso de escrita/modificação a certos diretórios para armazenar ficheiros como imagens e PDFs. Também armazena dados temporários (também conhecidos como: cache) для otimizar o desempenho do seu website.',
        runwayFromScratch: 'Quero começar do zero',
        runwayFromScratchText: 'O seu website está completamente vazio neste momento, o que é perfeito se quiser começar do zero e criar os seus próprios Tipos de Documento e modelos.   (<a href="https://umbraco.tv/documentation/videos/for-site-builders/foundation/document-types">aprenda como</a>) Ainda pode optar por instalar o Runway mais tarde. Por favor, vá à secção Desenvolvedor e escolha Pacotes.',
        ...
        theEndBrowseSite: '<h3>Navegue no seu novo site</h3> Instalou o Runway, então porque não ver como está o seu novo website.',
        theEndFurtherHelp: '<h3>Ajuda e informação adicional</h3>\nObtenha ajuda da nossa comunidade premiada, navegue na documentação ou veja alguns vídeos gratuitos sobre como construir um site simples, como usar pacotes e um guia rápido sobre a terminologia do Umbraco',
        theEndHeader: 'O Umbraco %0% está instalado e pronto a usar',
        theEndInstallFailed: "Para terminar a instalação, terá de   editar manualmente o ficheiro <strong>/web.config</strong> e atualizar a chave AppSetting <strong>UmbracoConfigurationStatus</strong> no final para o valor de <strong>'%0%'</strong>.",
        theEndInstallSuccess: 'Pode começar <strong>instantaneamente</strong> clicando no botão "Iniciar Umbraco" abaixo.<br />Se for <strong>novo no Umbraco</strong>, pode encontrar muitos recursos nas nossas páginas de introdução.',
        theEndOpenUmbraco: '<h3>Iniciar Umbraco</h3>\nPara gerir o seu website, simplesmente abra o backoffice do Umbraco e comece a adicionar conteúdo, atualizar os modelos e folhas de estilo ou adicionar nova funcionalidade',
        Unavailable: 'Falha na ligação à base de dados.',
        Version3: 'Umbraco Versão 3',
        Version4: 'Umbraco Versão 4',
        watch: 'Ver',
        welcomeIntro: 'Este assistente irá guiá-lo através do processo de configuração do <strong>Umbraco %0%</strong> para uma nova instalação ou atualização da versão 3.0.<br /><br />Pressione <strong>"seguinte"</strong> para iniciar o assistente.',
    },
    language: {
    ...
    moveOrCopy: {
        ...
        notAllowedByPath: 'O nó atual não pode ser movido para uma das suas subpáginas, nem o pai e o destino podem ser os mesmos',
    ...
    packager: {
        ...
        created: 'Criado',
        createPackage: 'Criar pacote',
        chooseLocalPackageText: 'Escolha o Pacote da sua máquina, clicando no botão Procurar<br /> e localizando o pacote. Os pacotes Umbraco geralmente têm uma extensão ".umb" ou ".zip". ',
        ...
        noPackagesDescription: "Navegue pelos pacotes disponíveis usando o ícone <strong>'Pacotes'</strong> no canto superior direito do seu ecrã",
        ...
        packageCompatibilityDescription: 'Este pacote é compatível com as seguintes versões do Umbraco, conforme reportado por membros da comunidade. A compatibilidade total não pode ser garantida para versões reportadas abaixo de 100%',
        ...
        packageNoItemsText: 'Este ficheiro de pacote não contém quaisquer itens para desinstalar.<br/><br/> Pode removê-lo com segurança do sistema clicando em "desinstalar pacote" abaixo.',
    ...
    paste: {
        ...
        errorMessage: 'O texto que está a tentar colar contém caracteres especiais ou formatação. Isto pode ser causado pela cópia de texto do Microsoft Word. O Umbraco pode remover caracteres especiais ou formatação automaticamente, para que o conteúdo colado seja mais adequado para a web.',
    ...
    publish: {
        ...
        contentPublishedFailedInvalid: '%0% não pôde ser publicado porque estas propriedades: %1% não passaram nas regras de validação.',
        ...
        publishHelp: 'Clique em <em>Publicar</em> para publicar <strong>%0%</strong> e assim tornar o seu conteúdo publicamente disponível.<br/><br /> Pode publicar esta página e todas as suas subpáginas marcando <em>Incluir subpáginas não publicadas</em> abaixo. ',
        invalidPublishBranchPermissions: 'Permissões de utilizador insuficientes para publicar todos os documentos descendentes',
        contentPublishedFailedReqCultureValidationError: "Falha na validação para o idioma obrigatório '%0%'. Este idioma foi guardado mas não publicado.",
    },
    colorpicker: {
    ...
    colorPickerConfigurations: {
        ...
        showLabelDescription: 'Armazena cores como um objeto JSON contendo tanto a string hexadecimal da cor como a etiqueta, em vez de apenas a string hexadecimal.',
    },
    contentPicker: {
        ...
        unsupportedHeadline: (type) => `<strong>Itens de ${type ?? 'conteúdo'} não suportados</strong><br>O seguinte conteúdo já não é suportado neste Editor.`,
        unsupportedMessage: 'Se ainda precisar deste conteúdo, entre em contacto com o seu administrador. Caso contrário, pode removê-lo.',
    ...
    dynamicRoot: {
        ...
        queryStepNearestAncestorOrSelfDesc: 'Consulte o ascendente ou atual mais próximo que se enquadre num dos tipos configurados',
        queryStepFurthestAncestorOrSelfTitle: 'Ascendente ou Atual Mais Distante',
        queryStepFurthestAncestorOrSelfDesc: 'Consulte o ascendente ou atual mais distante que se enquadre num dos tipos configurados',
        queryStepNearestDescendantOrSelfTitle: 'Descendente ou Atual Mais Próximo',
        queryStepNearestDescendantOrSelfDesc: 'Consulte o descendente ou atual mais próximo que se enquadre num dos tipos configurados',
        queryStepFurthestDescendantOrSelfTitle: 'Descendente ou Atual Mais Distante',
        queryStepFurthestDescendantOrSelfDesc: 'Consulte o descendente ou atual mais distante que se enquadre num dos tipos configurados',
        ...
        noValidStartNodeDesc: 'A configuração desta propriedade não corresponde a nenhum conteúdo. Crie o conteúdo em falta ou contacte o seu administrador para ajustar as definições de Raiz Dinâmica para esta propriedade.',
    ...
    rollback: {
        ...
        diffHelp: 'Isto mostra as diferenças entre a versão atual (rascunho) e a versão selecionada<br /><del>Texto a vermelho</del> será removido na versão selecionada, <ins>texto a verde</ins> será adicionado',
        ...
        htmlHelp: 'Isto exibe a versão selecionada como HTML, se desejar ver a diferença entre 2 versões ao mesmo tempo, use a vista de diferenças',
    ...
    settings: {
        ...
        importDocumentTypeHelp: 'Para importar um Tipo de Documento, encontre o ficheiro ".udt" no seu computador clicando no botão "Importar" (ser-lhe-á pedida confirmação no ecrã seguinte)',
        ...
        noPropertiesDefinedOnTab: 'Nenhuma propriedade definida neste separador. Clique no link "adicionar uma nova propriedade" no topo para criar uma nova propriedade.',
    ...
    sort: {
        ...
        sortHelp: 'Arraste os diferentes itens para cima ou para baixo abaixo para definir como devem ser organizados. Ou clique nos cabeçalhos das colunas para ordenar toda a coleção de itens',
    ...
    speechBubbles: {
        ...
        folderUploadNotAllowed: 'Este ficheiro está a ser carregado como parte de uma pasta, mas a criação de uma nova pasta não é permitida aqui',
        ...
        contentMandatoryCultureUnpublished: "O idioma obrigatório '%0%' foi despublicado. Todos os idiomas para este item de conteúdo estão agora despublicados.",
        ...
        contentReqCulturePublishError: "Não é possível publicar o documento uma vez que o '%0%' obrigatório não está publicado",
        ...
        publishWithNoDomains: 'Os domínios não estão configurados para o site multilingue, por favor contacte um administrador, veja os logs para mais informação',
        publishWithMissingDomain: 'Não existe nenhum domínio configurado para %0%, por favor contacte um administrador, veja os logs para mais informação',
        ...
        editMultiVariantUnpublishedText: '%0% documentos despublicados para os idiomas %1% e já não estão visíveis no website',
        ...
        scheduleErrReleaseDate2: "Não é possível agendar o documento para publicação uma vez que o '%0%' obrigatório não está publicado",
        scheduleErrReleaseDate3: "Não é possível agendar o documento para publicação uma vez que o '%0%' obrigatório tem uma data de publicação posterior a um idioma não obrigatório",
    ...
    template: {
        ...
        insertDictionaryItemDesc: 'Um item do dicionário é um marcador de posição para um pedaço de texto traduzível, o que facilita a criação de designs para websites multilingues.',
        insertMacro: 'Macro',
        insertMacroDesc: 'Uma Macro é um componente configurável que é ótimo para partes reutilizáveis do seu design, onde precisa da opção de fornecer parâmetros, como galerias, formulários e listas.',
        insertPageField: 'Valor',
        insertPageFieldDesc: 'Exibe o valor de um campo nomeado da página atual, com opções para modificar o valor ou recorrer a valores alternativos.',
        insertPartialView: 'Vista Parcial',
        insertPartialViewDesc: 'Uma Vista Parcial é um ficheiro de modelo separado que pode ser renderizado dentro de outro template, é ótimo para reutilizar marcação ou para separar modelos complexos em ficheiros separados.',
        ...
        renderBodyDesc: 'Renderiza o conteúdo de um template filho, inserindo um marcador de posição <code>@RenderBody()</code>.',
        defineSection: 'Definir uma secção nomeada',
        defineSectionDesc: 'Define uma parte do seu template como uma secção nomeada, envolvendo-a em <code>@section { ... }</code>. Isto pode ser renderizado numa área específica do pai deste template, usando <code>@RenderSection</code>.',
        renderSection: 'Renderizar uma secção nomeada',
        renderSectionDesc: 'Renderiza uma área nomeada de um template filho, inserindo um marcador de posição <code>@RenderSection(name)</code>. Isto renderiza uma área de um template filho que está envolvida numa definição <code>@section [name]{ ... }</code> correspondente.',
        sectionName: 'Nome da Secção',
        sectionMandatory: 'A secção é obrigatória',
        sectionMandatoryDesc: 'Se for obrigatório, o template filho deve conter uma definição <code>@section</code>, caso contrário é mostrado um erro.',
    ...
    grid: {
        ...
        gridLayoutsDetail: 'Os layouts são a área de trabalho geral para o editor de grelha, geralmente só precisa de um ou dois layouts diferentes',
        ...
        warning: 'Aviso',
        warningText: '<p>Modificar um nome de configuração de linha resultará na perda de dados para qualquer conteúdo existente que seja baseado nesta configuração.</p> <p><strong>Modificar apenas a etiqueta não resultará em perda de dados.</strong></p>',
        youAreDeleting: 'Está a eliminar a configuração da linha',
        deletingARow: 'Eliminar um nome de configuração de linha resultará na perda de dados para qualquer conteúdo existente que seja baseado nesta configuração.',
        deleteLayout: 'Está a eliminar o layout',
        deletingALayout: 'Modificar um layout resultará na perda de dados para qualquer conteúdo existente que seja baseado nesta configuração.',
    },
    contentTypeEditor: {
        compositions: 'Composições',
        group: 'Grupo',
        groupReorderSameAliasError: 'Não pode mover o grupo %0% para este separador porque o grupo terá o mesmo alias que um separador: "%1%". Renomeie o grupo para continuar.',
        ...
        enableListViewDescription: 'Configura o item de conteúdo para mostrar uma lista ordenável e pesquisável dos seus filhos.',
        ...
        compositionsDescription: 'Herde separadores e propriedades de um Tipo de Documento existente. Novos separadores serão adicionados ao Tipo de Documento atual ou fundidos se existir um separador com um nome idêntico.',
        ...
        compositionRemoveWarning: 'Remover uma composição eliminará todos os dados de propriedade associados. Depois de guardar o Tipo de Documento, não há como voltar atrás.',
        ...
        usingThisDocument: 'usando este Tipo de Documento será eliminado permanentemente, por favor confirme que quer eliminá-los também.',
        usingThisMedia: 'usando este Tipo de Multimédia será eliminado permanentemente, por favor confirme que quer eliminá-los também.',
        usingThisMember: 'usando este Tipo de Membro será eliminado permanentemente, por favor confirme que quer eliminá-los também',
        ...
        isSensitiveDataDescription: 'Ocultar este valor de propriedade de editores de conteúdo que não têm acesso para visualizar informação sensível',
        ...
        elementDescription: 'Um Tipo de Elemento destina-se a ser usado noutros Tipos de Documento, e não na árvore de Conteúdo.',
        elementCannotToggle: 'Um Tipo de Documento não pode ser alterado para um Tipo de Elemento depois de ter sido usado para criar um ou mais itens de conteúdo.',
        ...
        removeChildNodeWarning: 'Remover um nó filho limitará as opções dos editores para criar diferentes tipos de conteúdo abaixo de um nó.',
        ...
        historyCleanupGloballyDisabled: '<strong>NOTA!</strong> A limpeza de versões históricas de conteúdo está desativada globalmente. Estas definições não terão efeito antes de ser ativada.',
        changeDataTypeHelpText: 'Alterar um tipo de dados com valores armazenados está desativado. Para permitir isto, pode alterar a definição Umbraco:CMS:DataTypes:CanBeChanged em appsettings.json.',
        collection: 'Coleção',
    ...
    languages: {
        ...
        fallbackLanguageDescription: 'Para permitir que o conteúdo multilingue recorra a outro idioma se não estiver presente no idioma solicitado, selecione-o aqui.',
    ...
    translation: {
        ...
        noTranslators: 'Nenhum utilizador tradutor encontrado. Por favor, crie um utilizador tradutor antes de começar a enviar conteúdo para tradução',
        ...
        translationDoneHelp: 'Pode pré-visualizar as páginas que acabou de traduzir, clicando abaixo. Se a página original for encontrada, obterá uma comparação das 2 páginas.',
    ...
    user: {
        ...
        changePasswordDescription: "Pode alterar a sua palavra-passe para aceder ao backoffice do Umbraco preenchendo o formulário abaixo e clicando no botão 'Alterar Palavra-passe'",
        contentChannel: 'Canal de Conteúdo',
        createAnotherUser: 'Criar outro utilizador',
        createUserHelp: 'Crie novos utilizadores para lhes dar acesso ao Umbraco. Quando um novo utilizador é criado, será gerada uma palavra-passe que pode partilhar com o utilizador.',
        ...
        inviteUserHelp: 'Convide novos utilizadores para lhes dar acesso ao Umbraco. Será enviado um email de convite ao utilizador com informação sobre como iniciar sessão no Umbraco. Os convites duram 72 horas.',
        language: 'Cultura da UI',
        languageHelp: 'Defina a cultura que verá nos menus e diálogos',
        languageNotFound: (culture, baseCulture) => `A cultura especificada "${culture}" não foi encontrada, a cultura base de "${baseCulture}" será usada.`,
        languageNotFoundFallback: (culture, baseCulture) => `Nem a cultura especificada "${culture}" nem a cultura base "${baseCulture}" foram encontradas, a cultura de recurso predefinida de "Inglês (Reino Unido)" será usada.`,
        ...
        passwordIsDifferent: 'Houve uma diferença entre a nova palavra-passe e a palavra-passe confirmada. Por favor, tente novamente!',
        ...
        userCreatedSuccessHelp: 'O novo utilizador foi criado com sucesso. Para iniciar sessão no Umbraco, use a palavra-passe abaixo.',
        ...
        userInvitedSuccessHelp: 'Foi enviado um convite ao novo utilizador com detalhes sobre como iniciar sessão no Umbraco.',
        userinviteWelcomeMessage: 'Olá e bem-vindo(a) ao Umbraco! Em apenas 1 minuto estará pronto, só precisamos que configure uma palavra-passe e adicione uma imagem para o seu avatar.',
        userinviteExpiredMessage: 'Bem-vindo(a) ao Umbraco! Infelizmente, o seu convite expirou. Por favor, contacte o seu administrador e peça-lhe para o reenviar.',
        userinviteAvatarMessage: 'Carregar uma foto sua facilitará o reconhecimento por outros utilizadores. Clique no círculo acima para carregar a sua foto.',
        writer: 'Escritor',
        ...
        '2faDisableText': 'Se desejar desativar este fornecedor de autenticação de dois fatores, deve introduzir o código mostrado no seu dispositivo de autenticação:',
        ...
        '2faQrCodeDescription': 'Digitalize este código QR com a sua aplicação de autenticação para ativar a autenticação de dois fatores',
    ...
    healthcheck: {
        ...
        checkErrorMessageDifferentExpectedValue: "Valor esperado '%1%' para '%2%' no ficheiro de configuração '%3%', mas encontrado '%0%'.",
        ...
        macroErrorModeCheckErrorMessage: "MacroErrors estão definidos como '%0%', o que impedirá que algumas ou todas as páginas do seu site carreguem completamente se houver erros nas macros. Corrigir isto definirá o valor para '%1%'.",
        ...
        httpsCheckConfigurationRectifyNotPossible: "A appSetting 'Umbraco:CMS:Global:UseHttps' está definida como 'false' no seu ficheiro appSettings.json. Assim que aceder a este site usando o esquema HTTPS, deve ser definida como 'true'.",
        httpsCheckConfigurationCheckResult: "A appSetting 'Umbraco:CMS:Global:UseHttps' está definida como '%0%' no seu ficheiro appSettings.json, os seus cookies estão %1% marcados como seguros.",
        compilationDebugCheckSuccessMessage: 'O modo de compilação de debug está desativado.',
        compilationDebugCheckErrorMessage: 'O modo de compilação de debug está atualmente ativado. Recomenda-se desativar esta definição antes de entrar em produção.',
        umbracoApplicationUrlCheckResultTrue: "A appSetting 'Umbraco:CMS:WebRouting:UmbracoApplicationUrl' está definida como <strong>%0%</strong>.",
        umbracoApplicationUrlCheckResultFalse: "A appSetting 'Umbraco:CMS:WebRouting:UmbracoApplicationUrl' não está definida.",
        clickJackingCheckHeaderFound: 'O header ou meta-tag <strong>X-Frame-Options</strong> usado para controlar se um site pode ser IFRAMEd por outro foi encontrado.',
        clickJackingCheckHeaderNotFound: 'O header ou meta-tag <strong>X-Frame-Options</strong> usado para controlar se um site pode ser IFRAMEd por outro não foi encontrado.',
        noSniffCheckHeaderFound: 'O header ou meta-tag <strong>X-Content-Type-Options</strong> usado para proteger contra vulnerabilidades de MIME sniffing foi encontrado.',
        noSniffCheckHeaderNotFound: 'O header ou meta-tag <strong>X-Content-Type-Options</strong> usado para proteger contra vulnerabilidades de MIME sniffing não foi encontrado.',
        hSTSCheckHeaderFound: 'O header <strong>Strict-Transport-Security</strong>, também conhecido como header HSTS, foi encontrado.',
        hSTSCheckHeaderNotFound: 'O header <strong>Strict-Transport-Security</strong> não foi encontrado.',
        hSTSCheckHeaderFoundOnLocalhost: 'O header <strong>Strict-Transport-Security</strong>, também conhecido como header HSTS, foi encontrado. <strong>Este header não deve estar presente no localhost.</strong>',
        hSTSCheckHeaderNotFoundOnLocalhost: 'O header <strong>Strict-Transport-Security</strong> não foi encontrado. Este header não deve estar presente no localhost.',
        xssProtectionCheckHeaderFound: 'O header <strong>X-XSS-Protection</strong> foi encontrado. <strong>Recomenda-se não adicionar este header ao seu website</strong>.<br />Pode ler sobre isto no <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection" target="_blank" rel="noopener" class="btn-link -underline">website da Mozilla</a> ',
        xssProtectionCheckHeaderNotFound: 'O header <strong>X-XSS-Protection</strong> não foi encontrado.',
        excessiveHeadersFound: 'Os seguintes headers que revelam informação sobre a tecnologia do website foram encontrados: <strong>%0%</strong>.',
        ...
        smtpMailSettingsConnectionSuccess: 'As definições SMTP estão configuradas corretamente e o serviço está a funcionar como esperado.',
        smtpMailSettingsConnectionFail: "O servidor SMTP configurado com o domínio '%0%' e a porta '%1%' não pôde ser alcançado. Por favor, verifique se as definições SMTP na configuração 'Umbraco:CMS:Global:Smtp' estão corretas.",
        notificationEmailsCheckSuccessMessage: 'O email de notificação foi definido para <strong>%0%</strong>.',
        notificationEmailsCheckErrorMessage: 'O email de notificação ainda está definido para o valor predefinido de <strong>%0%</strong>.',
        checkGroup: 'Verificar grupo',
        helpText: '<p>O verificador de saúde avalia várias áreas do seu site para configurações de melhores práticas, configuração, problemas potenciais, etc. Pode facilmente corrigir problemas pressionando um botão.   Pode adicionar as suas próprias verificações de saúde, consulte <a href="https://docs.umbraco.com/umbraco-cms/extending/health-check" target="_blank" rel="noopener" class="btn-link -underline">a documentação para mais informação</a> sobre verificações de saúde personalizadas.</p>',
    },
    redirectUrls: {
        ...
        noRedirectsDescription: 'Quando uma página publicada é renomeada ou movida, um redirecionamento será automaticamente feito para a nova página.',
        ...
        disableError: 'Erro ao desativar o monitorizador de URLs, mais informação pode ser encontrada no seu ficheiro de logs.',
    ...
    recycleBin: {
        ...
        itemCannotBeRestoredHelpText: 'Não existe nenhuma localização onde este item possa ser restaurado automaticamente. Pode mover o item manualmente usando a árvore abaixo.',
    ...
    visuallyHiddenTexts: {
        ...
        searchInputDescription: 'Quando os resultados da autocompletação estiverem disponíveis, prima as setas para cima e para baixo, ou use a tecla tab e use a tecla enter para selecionar.',
        path: 'Caminho:',
    ...
    references: {
        ...
        deleteWarning: 'Este item ou os seus descendentes estão a ser usados. A eliminação pode levar a links quebrados no seu website.',
        unpublishWarning: 'Este item ou os seus descendentes estão a ser usados. A despublicação pode levar a links quebrados no seu website. Por favor, tome as medidas apropriadas.',
        deleteDisabledWarning: 'Este item ou os seus descendentes estão a ser usados. Portanto, a eliminação foi desativada.',
    ...
    nuCache: {
        ...
        memoryCacheDescription: 'Este botão permite recarregar a cache na memória, recarregando-a inteiramente da cache da base de dados (mas não reconstrói essa cache da base de dados). Isto é relativamente rápido. Use-o quando achar que a cache de memória não foi devidamente atualizada, após alguns eventos acionados — o que indicaria um pequeno problema no Umbraco. (nota: aciona o recarregamento em todos os servidores num ambiente LB, e limpará a cache de segundo nível se a tiver ativada).',
        reload: 'Recarregar',
        databaseCache: 'Cache da Base de Dados',
        databaseCacheDescription: 'Este botão permite reconstruir a cache da base de dados, por exemplo, o conteúdo da tabela cmsContentNu. <strong>A reconstrução pode ser dispendiosa.</strong> Use-o quando o recarregamento não for suficiente, e achar que a cache da base de dados não foi devidamente gerada — o que indicaria algum problema crítico no Umbraco.',
        rebuild: 'Reconstruir',
        internals: 'Internos',
        internalsDescription: 'Este botão permite acionar uma coleção de instantâneos NuCache (depois de executar um GC CLR completo). A menos que saiba o que isso significa, provavelmente <em>não</em> precisa de o usar.',
        collect: 'Recolher',
    ...
    profiling: {
        ...
        reminderDescription: '<p>Nunca deve deixar um site de produção a ser executado em modo de debug. O modo de debug é desativado definindo <strong>Umbraco:CMS:Hosting:Debug</strong> como <strong>false</strong> em appsettings.json, appsettings.{Environment}.json ou através de uma variável de ambiente.</p>',
    ...
    settingsDashboardVideos: {
        ...
        trainingDescription: '<p>Quer dominar o Umbraco? Gaste alguns minutos a aprender algumas das melhores práticas vendo um destes vídeos sobre como usar o Umbraco. E visite <a href="https://umbraco.tv" target="_blank" rel="noopener">umbraco.tv</a> para ainda mais vídeos Umbraco</p>',
        learningBaseDescription: '  <p>Quer dominar o Umbraco? Gaste alguns minutos a aprender algumas das melhores práticas visitando <a class="btn-link -underline" href="https://www.youtube.com/c/UmbracoLearningBase" target="_blank" rel="noopener">o canal de Youtube da Base de Aprendizagem Umbraco</a>. Aqui pode encontrar muito material em vídeo cobrindo muitos aspetos do Umbraco.</p> ',
    ...
    settingsDashboard: {
        ...
        supportDescription: 'Expanda a sua equipa com um grupo altamente qualificado e apaixonado de especialistas em Umbraco.',
        videosHeader: 'Vídeos',
        videosDescription: 'Veja os nossos tutoriais em vídeo gratuitos no canal de Youtube da Base de Aprendizagem Umbraco, para se familiarizar rapidamente com o Umbraco.',
    ...
    startupDashboard: {
        ...
        fallbackDescription: 'Obrigado por escolher o Umbraco - achamos que isto pode ser o início de algo bonito. Embora possa parecer esmagador no início, fizemos muito para tornar a curva de aprendizagem o mais suave e rápida possível.',
    },
    welcomeDashboard: {
        ourUmbracoHeadline: 'Our Umbraco - A Comunidade Mais Amigável',
        ourUmbracoDescription: 'Our Umbraco, o site oficial da comunidade, é o seu balcão único para tudo relacionado com o Umbraco. Quer precise de uma resposta a uma pergunta, plugins interessantes ou um guia de como fazer algo no Umbraco, a melhor e mais amigável comunidade do mundo está apenas a um clique de distância.',
    ...
    blockEditor: {
        ...
        labelCustomViewDescription: 'Substitua como este bloco aparece na UI do backoffice. Escolha um ficheiro .html contendo a sua apresentação.',
        ...
        confirmDeleteBlockTypeNotice: 'O conteúdo deste bloco continuará presente, a edição deste conteúdo já não estará disponível e será mostrada como conteúdo não suportado.',
        confirmDeleteBlockGroupTitle: 'Eliminar grupo?',
        confirmDeleteBlockGroupMessage: 'Tem a certeza que quer eliminar o grupo <strong>%0%</strong> e todas as configurações de Bloco deste?',
        confirmDeleteBlockGroupNotice: 'O conteúdo destes Blocos continuará presente, a edição deste conteúdo já não estará disponível e será mostrada como conteúdo não suportado.',
        ...
        forceHideContentEditorHelp: 'Ocultar o botão de edição de conteúdo e o editor de conteúdo da sobreposição do Editor de Blocos.',
        gridInlineEditing: 'Edição em linha',
        gridInlineEditingHelp: 'Ativa a edição em linha para a primeira Propriedade. Propriedades adicionais podem ser editadas na sobreposição.',
        ...
        areaAllowedBlocksHelp: 'Defina os tipos de blocos que são permitidos nesta área, e opcionalmente quantos de cada tipo devem estar presentes.',
        ...
        allowedBlockColumnsHelp: 'Defina o número diferente de colunas que este bloco pode abranger. Isto não impede que os Blocos sejam colocados em Áreas com uma extensão de coluna menor.',
        ...
        allowBlockInAreasHelp: 'Tornar este bloco disponível por predefinição dentro das áreas de outros Blocos (a menos que permissões explícitas sejam definidas para estas áreas).',
        areaAllowedBlocksEmpty: 'Por predefinição, todos os tipos de bloco são permitidos numa Área. Use esta opção para permitir apenas tipos selecionados.',
        areas: 'Áreas',
        areasLayoutColumns: 'Colunas de Grelha para Áreas',
        areasLayoutColumnsHelp: 'Defina quantas colunas estarão disponíveis para áreas. Se não definido, será usado o número de colunas definido para todo o layout.',
        areasConfigurations: 'Áreas',
        areasConfigurationsHelp: "Para ativar o aninhamento de blocos dentro deste bloco, defina uma ou mais áreas. As áreas seguem o layout definido pela sua própria configuração de coluna de grelha. A 'extensão de coluna' e 'extensão de linha' para cada área podem ser ajustadas usando a caixa do manipulador de escala no canto inferior direito da área selecionada.",
        ...
        confirmPasteDisallowedNestedBlockMessage: 'O conteúdo inserido continha conteúdo não permitido, que não foi criado. Gostaria de manter o resto deste conteúdo mesmo assim?',
        areaAliasHelp: 'Ao usar GetBlockGridHTML() para renderizar a Block Grid, o alias será renderizado na marcação como um atributo \'data-area-alias\'. Use o atributo alias para direcionar o elemento para a área. Exemplo: .umb-block-grid__area[data-area-alias="MinhaAreaAlias"] { ... }',
        scaleHandlerButtonTitle: 'Arraste para escalar',
        areaCreateLabelTitle: 'Etiqueta do Botão Criar',
        areaCreateLabelHelp: "Substitua o texto da etiqueta para adicionar um novo Bloco a esta Área, Exemplo: 'Adicionar Widget'",
        ...
        getSampleDescription: 'Isto adicionará Blocos básicos e ajudá-lo-á a começar com o Editor de Block Grid. Terá Blocos para Título, Texto Rico, Imagem, bem como um Layout de Duas Colunas.',
        ...
        createThisFor: (name, variantName) => variantName ? `Criar ${name} para ${variantName}` : `Criar ${name}`,
        ...
        unsupportedBlockDescription: 'Este conteúdo já não é suportado neste Editor. Se lhe falta este conteúdo, por favor contacte o seu administrador. Caso contrário, elimine-o.',
        blockVariantConfigurationNotSupported: 'Um ou mais Tipos de Bloco deste Editor de Blocos estão a usar um Tipo de Elemento que está configurado para Variar por Cultura ou Variar por Segmento. Isto não é suportado num item de Conteúdo que não varia por Cultura ou Segmento.',
    },
    contentTemplatesDashboard: {
        whatHeadline: 'O que são Modelos de Documento?',
        whatDescription: 'Modelos de Documento são conteúdo predefinido que pode ser selecionado ao criar um novo nó de conteúdo.',
        createHeadline: 'Como crio um Modelo de Documento?',
        createDescription: '<p>Existem duas formas de criar um Modelo de Documento:</p><ul><li>Clique com o botão direito num nó de conteúdo e selecione "Criar Modelo de Documento" para criar um novo Modelo de Documento.</li><li>Clique com o botão direito na árvore de Modelos de Documento na secção Definições e selecione o Tipo de Documento para o qual quer criar um Modelo de Documento.</li></ul><p>Depois de lhe ser dado um nome, os editores podem começar a usar o Modelo de Documento como base para a sua nova página.</p>',
        manageHeadline: 'Como gero Modelos de Documento?',
        manageDescription: 'Pode editar e eliminar Modelos de Documento da árvore "Modelos de Documento" na secção Definições. Expanda o Tipo de Documento no qual o Modelo de Documento se baseia e clique nele para editar ou eliminar.',
    },
    preview: {
        endLabel: 'Terminar',
        ...
        returnToPreviewDescription: 'Terminou o modo de pré-visualização, quer ativá-lo novamente para ver a última versão guardada do seu website?',
        ...
        viewPublishedContentDescription: 'Está em Modo de Pré-visualização, quer sair para ver a versão publicada do seu website?',
    ...
    tiptap: {
        ...
        config_dimensions_description: 'Definir uma largura e altura fixas para o editor. Isso exclui as alturas da barra de ferramentas e da barra de estado.',
    ...
    linkPicker: {
        modalSource: 'Fonte',
        modalManual: 'Manual',
        modalAnchorValidationMessage: 'Por favor, introduza uma âncora ou querystring, selecione um documento ou item de multimédia, ou configure manualmente o URL.',
